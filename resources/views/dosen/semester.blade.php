        ...
        <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-4">
                  <img src="{{asset('semester.svg')}}" width="100%">
                  <br class="mt-3">
                  <p>Notes :</p>
                  <ul>
                    <li>Klik button pada kolom is active untuk merubah status semester yang sedang aktif.</li>
                    <li>Semua data yang ditanpilkan berdasarkan semester yang sedang aktif.</li>
                    <li>Status default pada tambah semester adalah Non Active.</li>
                    <li>Jika semester dihapus maka seluruh data yang berkaitan dengan semester tersebut akan ikut terhapus.</li>
                  </ul>
                </div>
              </div>
            </div>
