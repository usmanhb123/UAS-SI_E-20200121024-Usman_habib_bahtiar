...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Kontrak Matakuliah Semester {{$semester->semester}}</h1>
        <div class="card">
              ...
              <div class="row">
                <div class="col-lg-8">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link @if($no == 0) active @endif" id="home-tab{{$item->id}}" data-toggle="tab" data-target="#home{{$item->id}}" type="button" role="tab" aria-controls="home" aria-selected="true">{{$item->nama_matakuliah}}</button>
                    </li>
                    @endforeach
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade @if($no == 0)  show active @endif" id="home{{$item->id}}" role="tabpanel" aria-labelledby="home-tab{{$item->id}}">
                    <div class="container">
                        <br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Save</button>
              ...
              <div class="col-lg-4">
                <img src="{{asset('reminder.svg')}}" width="70%" class="mt-5">
